...
Core3 = {
    ...
    DBName = "swgemu",
    DBUser = "swgemu",
    DBPass = "swgemu_password",
    DBInstances = 2,
    DBSecret = "@WSX(IJN", -- Change this! This value should be unique and of reasonable length.
    ...
    MantisHost = "swg_database",
    MantisPort = 3306,
    MantisName = "swgemu",
    MantisUser = "swgemu",
    MantisPass = "swgemu_password",
